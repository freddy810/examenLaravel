    ...
    @section('content')
        ...
        <div class="row">
          ...
          <div class="col-md-6 mt-4">
            ...
            <a href="{{route('reservations.create')}}" class="btn btn-secondary mb-4">
                ...
                <tr>
                  ...
                  <td class="d-flex justify-content-between">
                    ...
                    <form action="{{route('reservations.destroy', $reservation->id)}}" method="POST">
                      @csrf
                      @method('DELETE')
                      <button type="submit" class="btn btn-danger" onclick="return confirm('Etes-vous sûr de vouloir supprimer ce reservation ?')">
